    ...
    public function contact()
    {
        ...
        if ($decode['success'] == true) {
            ...
            $message = (new \Swift_Message())
                ->setSubject('Portfolio Estiam, nouveau message d\'un vitieur')
    ...
    public function forgotPassword()
    {
        ...
        if ($decode['success'] == true) {
            ...
            if ($this->usermanager->exists($secure_mail)) {
                ...
                // Create a message
                $message = (new \Swift_Message())
                    ->setSubject('Portfolio Estiam, réinitialisez votre mot de passe')
    ...
    */
    public function signUp()
    {
        ...
        if ($decode['success'] == true) {
            ...
            // Create a message
            $message = (new \Swift_Message())
                ->setSubject('Portfolio Estiam, validez votre compte')
                ->setFrom([nl2br(htmlspecialchars($data['email'])) => nl2br(htmlspecialchars($data['name']))])
